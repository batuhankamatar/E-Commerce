    ...
    <div className="w-full max-w-[1050px] mx-auto px-4 lg:px-0 flex flex-col lg:flex-row items-center justify-between gap-4">
      ...
      <div className="flex items-center gap-[15px]">
        <select
          ...
          className="w-[141px] h-[50px] border border-[#ECECEC] rounded px-[18px] font-normal text-[14px] leading-7 tracking-[0.2px] text-[#737373] outline-none cursor-pointer"
        >
        ...
        <button
          onClick={onFilter}
          className="w-[94px] h-[50px] bg-[#23A6F0] rounded-[5px] flex items-center justify-center font-bold text-[14px] leading-6 tracking-[0.2px] text-white hover:bg-[#1a7bb3] transition-colors"
        >
          Filter
        </button>
      </div>
